...
urlpatterns = [
    ...
    pattern(r"^deleted/$", views.DeletedNotificationsList.as_view(), name="deleted"),
    ...
    pattern(
        r"^api/deleted_count/$",
        views.live_deleted_notification_count,
        name="live_deleted_notification_count",
    ),
    pattern(
        r"^api/unread_count/$",
    ...
    pattern(
        r"^api/deleted_list/$",
        views.live_deleted_notification_list,
        name="live_deleted_notification_list",
    ),
    pattern(
        r"^api/unread_list/$",
